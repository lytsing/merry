...
<div class="block ui-tabs-panel active" id="option-general" >	
	<form method="post" id="weblizar_theme_options_general">
		<div id="heading">
			<table style="width:100%;"><tr>
				...
				<td style="width:30%;">
					...
					<div class="weblizar_settings_massage" id="weblizar_settings_save_general_success" ><?php echo _e('Options Data updated','weblizar');?></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_general_reset" ><?php echo _e('Options data Reset','weblizar');?></div>
				</td>
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults','weblizar') ;?>" onclick="weblizar_option_data_reset('general');">
					<input class="button button-primary" type="button" value="<?php esc_attr_e('Save Options','weblizar') ;?>" onclick="weblizar_option_data_save('general')" >
				</td>
				</tr>
			</table>			
		</div>	
					...
					<div id="collapseOne" class="panel-collapse collapse ">
					  <div class="panel-body">						
							...
							<div class="section">
								...
								<span class="explain"><?php _e('Enable Custom Background .Set background','weblizar');?> <a href="<?php echo esc_url(home_url( '/' )); ?>wp-admin/themes.php?page=custom-background"><?php _e('Click Here','weblizar');?></a>.</span>
							</div><br>
							<a href="<?php echo $get_pro_url; ?>" target="_blank" class="btn btn-info  btn_upsell"><?php echo $get_pro; ?></a>
					  </div>
					</div>
		...
		<div class="section">
			...
			<input type="checkbox" <?php if($wl_theme_options['_frontpage']=='on') echo "checked='checked'"; ?> id="_frontpage" name="_frontpage" > <span class="explain"><?php _e('Enable Custom Static Front-Page.','weblizar');?> <a href="<?php echo esc_url(home_url( '/' )); ?>wp-admin/options-reading.php"><?php _e('Click Here','weblizar');?></a>.</span>
		</div>	
		<div class="section">
		...
		<div class="section">
			...
			<input type="checkbox" <?php if($wl_theme_options['text_title']=='on') echo "checked='checked'"; ?> id="text_title" name="text_title" > <span class="explain"><?php _e('Enable text-based Site Title.   Setup title','weblizar');?> <a href="<?php echo esc_url(home_url( '/' )); ?>wp-admin/options-general.php"><?php _e('Click Here','weblizar');?></a>.</span>
		</div>
		<div class="section">
		...
		<div id="heading">
			<table style="width:100%;"><tr>
				...
				<td style="width:30%;">
					...
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-image_success" ><?php echo _e('Options Data updated','weblizar');?></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-image_reset" ><?php echo _e('Options data Reset','weblizar');?></div>
				</td>
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults','weblizar') ;?>" onclick="weblizar_option_data_reset('home-image');">
					<input class="button button-primary" type="button" value="<?php esc_attr_e('Save Options','weblizar') ;?>" onclick="weblizar_option_data_save('home-image')" >
				</td>
				</tr>
			</table>			
		</div>	
		...
		<div id="heading">
			<table style="width:100%;"><tr>
				...
				<td style="width:30%;">
					...
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-service_success" ><?php echo _e('Options Data updated','weblizar');?></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-service_reset" ><?php echo _e('Options data Reset','weblizar');?></div>
				</td>
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults','weblizar') ;?>" onclick="weblizar_option_data_reset('home-service');">
					<input class="button button-primary" type="button" value="<?php esc_attr_e('Save Options','weblizar') ;?>" onclick="weblizar_option_data_save('home-service')" >
				</td>
				</tr>
			</table>			
		</div>
		...
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Social media','weblizar');?></h2></td>
					...
					<td style="text-align:right;">					
						<input class="button" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults','weblizar') ;?>" onclick="weblizar_option_data_reset('social');">
						<input class="button button-primary" type="button" value="<?php esc_attr_e('Save Options','weblizar') ;?>" onclick="weblizar_option_data_save('social')" >
					</td>
				</tr>
			</table>	
		</div>
	...
	<form method="post" id="weblizar_theme_options_footer">
		<div id="heading">
			<table style="width:100%;"><tr>
				...
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="<?php esc_attr_e('Restore Defaults','weblizar') ;?>" onclick="weblizar_option_data_reset('footer');">
					<input class="button button-primary" type="button" value="<?php esc_attr_e('Save Options','weblizar') ;?>" onclick="weblizar_option_data_save('footer')" >
				</td>
				</tr>
			</table>			
		</div>	
